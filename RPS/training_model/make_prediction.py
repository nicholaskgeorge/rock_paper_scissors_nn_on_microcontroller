...
model = load_model("RPS/pretrained_models/rps2.h5")  # Update the path as needed
...
print(predict_image("/Users/nicokofi/Documents/GitHub/AI_managment/RPS/xiao_program/debug_model/frame_2_4592.bmp"))